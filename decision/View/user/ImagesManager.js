...
$View.user.ImagesManager = function (j) {
    ...
    function layout() {
        var _userHAry = [
            ...
            { name: 'userId', type: 'none', ifTrans: true, trans: 'SYS_TRANS_TJ_USER', title: '上传者', width: 150 },
            { name: 'address', type: 'none', title: '地址', width: 150, ifFilter: true, filterItems: ['like'] },
            ...
            { name: 'zan', type: 'none', title: '赞数', width: 150 },
            { name: 'latitude', type: 'none', title: 'Latitude', width: 150 },
            { name: 'longitude', type: 'none', title: 'Longitude', width: 150 },
        ...
        var comArgs = {
            ...
            'userForm': {
                ...
                updateApi: 'm=TJ_PICTURE&action=updatePictureState',
                items: _userInfo,
                btnItems: [
