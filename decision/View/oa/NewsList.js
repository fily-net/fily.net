...
$View.oa.NewsList = function (j) {
    ...
    function addItem(obj) {
        eList.adElm('', 'li').h(_html.format(obj.id, obj.title, obj.cPerson, obj.cTime, obj.uid));
    }
