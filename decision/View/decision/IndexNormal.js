...
$View.decision.IndexNormal = function (j) {
    var me = this, _fn = function () { };
    var owner;
    var args = { p: $DB, gtRootID: 156, fireid: null }, popTips;
    ...
    function onListDClick(obj) { new $.UI.View({ p: args.p, title: obj.getAttr('nodeName'), type: 'normal', url: 'View/decision/PMInfo.js', proId: obj.getAttr('rowid') }); }
    function onToolClick(obj) {
        if (obj.Name == 'toUL') { new $.UI.View({ p: args.p, url: 'View/decision/Index.js' }); return; }
        switch (+obj.Name) {
            case 189:
                //新建项目
                var infoAry = [
