...
$View.website.Document = function (j) {
    var me = this, _fn = function () { };
    var owner;
    var args = { p: $DB, table: 'SYS_CM_FILES', rootID: 6, gbsID: 16, title: '文档管理' };
    var coms = {}, dirList, fileList, currID = 6, popTips, fileID, infoF;
    ...
    function layout() {
        ...
        var _userInfo = [
            { name: 'url', title: '网址链接', group: { name: 'g1', width: 800 }, width: 630, comType: 'Input' },
            { name: 'imageUrl', title: '图片链接', group: 'g1', width: 630, comType: 'FileView' },
            { name: 'videoUrl', title: '视频链接', group: 'g1', width: 630, comType: 'FileView' }
        ];
        var comArgs = {
            ...
            'userForm': {
                head_h: 0,
                state: 'Update',
                loadApi: 'm=SYS_TABLE_BASE&table=SYS_CM_FILES&action=getByID',
                updateApi: 'm=SYS_TABLE_BASE&table=SYS_CM_FILES&action=updateByID',
                items: _userInfo,
        ...
        var struct = {
            ...
            body: {
                ...
                eFoot: {
                    type: 'Layout',
                    name: 'userLayout',
                    eHead: { type: 'List', name: 'fileList' },
                    eFoot: { type: 'Form', name: 'userForm' }
                }
            }
        }
        coms = $.Util.initUI({ args: comArgs, struct: struct });
        dirList = coms.dirList; fileList = coms.fileList; infoF = coms.userForm;
    ...
    function onListTDClick(obj) {
        ...
        infoF.loadDataByID(fileID, function () { infoF.getButton('FORM-SYS-SUBMIT').setIcon('fa fa-edit').setText('修改信息'); });
        //console.log(fileID);
    }
    ...
    function loadFiles(id) {
        $.Util.ajax({
            args: 'm=SYS_TABLE_TREE&table=' + args.table + '&action=pagingListByPid&pid=' + currID,
            onSuccess: function () {
