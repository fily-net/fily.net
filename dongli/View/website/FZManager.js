...
$View.website.FZManager = function (j) {
    ...
    function layout() {
        ...
        var _mHeaderAry = [
            ...
            { title: '标题', name: 'title', type: 'none', width: 120, ifFilter: 1, ifSort: 1 },
            { title: '链接', name: 'url', type: 'none', width: 100, ifFilter: 1, ifSort: 1 },
            { title: '图片', name: 'image', type: 'none', width: 100, ifFilter: 1, ifSort: 1 },
        ...
        var _mItemAry = [
            { title: '标题', name: 'title', comType: 'Input', group: { name: 'g1', width: 300} },
            { title: '链接', name: 'url', comType: 'Input', group: 'g1' },
            { title: '图片', name: 'image', comType: 'Input', group: 'g1' },
        ...
        var comArgs = {
            'rootTips': { head_h: 33, title: '服装类型及列表管理', icon: 'fa fa-icon-th', cn: 'b0', gbsID: 121, toolBarSkin: 'mr10 Button-default', onToolBarClick: onToolBarClick },
            'rootLayout': { min: 244, max: 500, isRoot: 1, start: 500, dir: 'we', dirLock: 1 },
            'sView': { url: 'View/common/TreeList.js', table: 'DL_CATAGORY', ifShowID: false, lockLevel: 2, rootID: 1, ifExpandAll: true, onTDClick: onStructClick },
            'infoView': { url: 'View/common/ListInfo.js', title: '服装信息', aHeader: _mHeaderAry, start: 250, fiAry: _mItemAry, table: 'DL_PRODUCT', onLoad: function (view) { dList = view; } }
        }
        var struct = {
            p: owner,
            name: 'rootTips',
