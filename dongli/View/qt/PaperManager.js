$.NameSpace('$View.qt');
$View.qt.PaperManager = function (j) {
    var me = this, _fn = function () { };
    var owner, table = 'SYS_QT_PAPER';
    var args = { p: $DB };
    var coms = {}, paperInfo, _currTR, tToolBar, mList, popTips;
    ...
    function layout() {
        ...
        var comArgs = {
            ...
            'paperInfo': { url: 'View/qt/PaperInfo.js', onLoad: function (view) { paperInfo = view; } }
        }
        var struct = {
            p: owner,
            type: 'Layout',
