...
$View.home.Notices = function (j) {
    ...
    function layout() {
        ...
        owner = args.p.h('<div class="info-panel"><div class="panel-head"><div class="info-title">施工信息</div><i class="info-tag" url="View/oa/NoticeList.js">' + args.allCount + '条</i></div><div class="panel-body scroll-webkit"><ul>' + _htmls + '</ul></div></div>').evt('click', onOwnerClick);
    }
