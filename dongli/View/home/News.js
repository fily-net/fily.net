...
$View.home.News = function (j) {
    ...
    var _html1 = '<li><div class="title"><a _tk="SYS_CM_NEWS" _tid="{0}" class="fa fa-arrow-circle-o-right"></a><div class="_title">{1}</div><div class="_info"><span style="margin-right:15px;">发布人：{2}</span><span>发布于：{3}</span></div></div></li>';
    ...
    function layout() {
        ...
        owner = args.p.h('<div class="info-panel"><div class="panel-head"><div class="info-title">公共信息</div><i class="info-tag" url="View/oa/NewsList.js">' + args.allCount + '条</i></div><div class="panel-body scroll-webkit"><ul>' + _htmls + '</ul></div></div>').evt('click', onOwnerClick);
    }
