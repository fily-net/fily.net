...
$View.oa.EmailDrafts = function (j) {
    ...
    function layout() {
        var _toolBarAry = [
            { text: '删除草稿件', cn: 'mr3 mt5', name: 'del', icon: 'fa-minus', skin: 'Button-danger' }
        ];
        var _listAry = [
        ...
        var comArgs = {
            'root': { head_h: 33, cn: 'b0', title: '草稿箱', icon: 'fa-envelope-square', toolBarAry: _toolBarAry, toolBarSkin: 'Button-default', onToolBarClick: onToolBarClick },
