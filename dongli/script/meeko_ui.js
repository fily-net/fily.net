...
$.UI.FormItem = function (j) {
    ...
    me.getValue = function () {
        switch (me.type) {
            case 'RichText':
                //console.log(htmlDecode(args.RichText.html()));
                //console.log(htmlDecode(args.RichText.html().replaceAll('\\', '\\\\')).replaceAll('<br>', ''));
                return htmlDecode(args.RichText.html().replaceAll('\\', '\\\\')).replaceAll('<br>', '').replaceAll('<br />', '');
            case 'Json':
    ...
    me.getText = function () {
        switch (me.type) {
            case 'RichText':
                return htmlDecode(args.RichText.html().replaceAll('\\', '\\\\'));
            case 'Json':
                return $.JSON.encode(args.Json.getValue());
            case 'Timer':
                var _eLast = $(eBody.lastChild);
