...
$View.vcms.Index = function (j) {
    ...
    function layout() {
        ...
        var comArgs = {
            ...
            'rootDiv': { head_h: 38 },
            'typeTab': { gtID: 818, gtType: 'tab', items: [{ name: 'all', type: 'tab', nn: '所有视频', text: '所有视频', ifPress: true }], skin: 'ButtonSet-tab fl', itemSkin: 'Button-tab', onClick: onTypeClick },
