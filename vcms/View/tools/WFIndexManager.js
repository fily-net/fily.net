...
$View.tools.WFIndexManager = function (j) {
    ...
    function layout() {
        ...
        var comArgs = {
            ...
            'infoForm': { title: '基本信息', updateApi: 'm=SYS_TABLE_TREE&table=SYS_WF_INDEX&action=updateNodeByID', loadApi: 'm=SYS_TABLE_TREE&table=SYS_WF_INDEX&action=getNodeByID', ifFixedHeight: false, head_h: 30, items: _fiAry },
