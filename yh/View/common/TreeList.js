...
$View.common.TreeList = function (j) {
    ...
    function layout() {
        ...
        var toolBarAry = [
            { name: 'addMain', text: '添加主项', icon: 'icon-glyph-plus-sign', onClick: addMain },
            { name: 'addSub', text: '添加子项', icon: 'icon-glyph-plus', onClick: addSub },
            { name: 'addBatch', text: '批量添加子项', icon: 'icon-compact-add', onClick: addBatch },
            { name: 'delSelItem', text: '删除选中项', icon: 'icon-glyph-remove-sign', onClick: delSelItem },
            { name: 'moveUp', text: '上移', icon: 'icon-glyph-arrow-up', onClick: moveUp },
            { name: 'moveDown', text: '下移', icon: 'icon-glyph-arrow-down', onClick: moveDown },
            { name: 'selAll', text: '全选', icon: 'icon-glyph-check', onClick: selAll },
            { name: 'invertSel', text: '反选', icon: 'icon-glyph-share', onClick: invertSel },
            { name: 'refresh', text: '刷新', icon: 'icon-glyph-refresh', onClick: refresh }
        ];
        var aHeader = [
            { name: 'id', type: 'attr' },
            { name: 'pid', type: 'attr' },
