...
$View.oa.Meeting = function (j) {
    ...
    function layout() {
        ...
        var comArgs = { 'root': { head_h: 32, foot_h: 0, cn: 'b0', title: '会议设置(<font color="red">提示：添加会议默认是添加当天会议</font>)', icon: 'icon-glyph-tasks', gbsID: 11, toolBarSkin: 'Button-default', onToolBarClick: onToolBarClick} }
