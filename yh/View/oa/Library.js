...
$View.oa.Library = function (j) {
    ...
    function layout() {
        ...
        var comArgs = {
            'rootTips': { head_h: 32, foot_h: 0, cn: 'b0', title: args.title, icon: 'icon-glyph-folder-close', toolBarSkin: 'Button-default', gbsID: args.gbsID, onToolBarClick: onToolBarClick },
