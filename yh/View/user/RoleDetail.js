...
$View.user.RoleDetail = function (j) {
    ...
    function layout() {
        ...
        var comArgs = { 'detailForm': { head_h: 25, icon: 'icon-glyph-arrow-right', state: 'Update', loadApi: 'm=SYS_CM_USERS&action=getDept', updateApi: 'm=SYS_CM_USERS&action=updateDept', ifFixedHeight: false, btnItems: [{ name: 'FORM-SYS-SUBMIT', text: '修改', icon: 'icon-glyph-edit', css: 'margin-left:102px;' }, { name: 'FORM-SYS-DEL', text: '删除', icon: 'icon-glyph-minus', css: 'margin-left:10px;'}], onClick: onFormClick} }
