...
$View.user.UserManager = function (j) {
    ...
    function layout() {
        var _userHAry = [
            ...
            { name: 'uid', type: 'none', title: '用户名', width: 120, ifFilter: true, filterItems: ['like'] },
        ...
        var _userInfo = [
            ...
            { name: 'department', title: '部门', comType: 'Select', group: 'g2', trans: 'SYS_TRANS_ROLE', loadApi: '', onChange: onDeptChange },
        ...
        var comArgs = {
            'userTips': { head_h: 30, title: '用户管理', icon: 'icon-glyph-user', cn: 'b0', onToolBarMouseDown: onToolBarMouseDown, onToolBarClick: onToolBarClick, toolBarSkin: 'mr5 Button-default', gbsID: 19 },
            ...
            'userForm': { head_h: 30, icon_h: 18, loadApi: 'm=SYS_TABLE_BASE&action=getByID&table=SYS_CM_USER', insertApi: 'm=SYS_CM_USERS&action=addUser', updateApi: 'm=SYS_CM_USERS&action=updateUser', title: '员工基本信息', icon: 'icon-vector-info-card', items: _userInfo, onFinishInit: onFormInit, onSubmitSuccess: onFormSubmitSuccess },
