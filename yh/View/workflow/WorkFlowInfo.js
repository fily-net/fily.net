...
$View.workflow.WorkFlowInfo = function (j) {
    ...
    var owner, coms = {};
    var args = { p: $DB, instanceId: -1, ifEdit: true, tid: '', ifAttach: false, ifEdit: true, ifFixedHeight: true, onNextSuccess: _fn, onLoadComplete: _fn, onCompleteBefore: _fn, onComplete: _fn, onRights: _fn, onConfirmBefore: _fn };
    ...
    function layout() {
        owner = args.p;
        var comArgs = { 'root': { ifFixedHeight: args.ifFixedHeight, icon: 'icon-compact-struct', toolBarSkin: 'Button-default', head_h: 32, cn: 'b0 wp'} }
                            ...
                            $.Util.ajax({
                                ...
                                onSuccess: function (data) {
                                    ...
                                    if (_uLen) {
                                        ...
                                        if (_ifPerson && toolBar && hasRight) { toolBar.addItem({ name: 'deny', text: '拒绝', align: 'right', cn: 'mr10' }); }
                                    }
                                }
                            });
                        }
