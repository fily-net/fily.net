...
namespace Meeko.Ext
{
    public class JsonNode
    {
        ...
        public JsonNode(string _key, int _value)
        {
            setValue(_key, _value);
        }
        public JsonNode(string _key, bool _value)
        {
            setValue(_key, _value);
        }
        public JsonNode(string _key, double _value)
        {
            setValue(_key, _value);
        }
        public JsonNode(string _key, string _value)
        {
            setValue(_key, _value);
        }
        public JsonNode(string _key, JsonNode _value)
        {
            setValue(_key, _value);
        }
        public JsonNode(string _key, Array _value)
        {
            setValue(_key, _value);
        }
        public JsonNode(string _key, DateTime _value)
        {
            setValue(_key, _value);
        }
        public JsonNode(string _key, object _value)
        {
            setValue(_key, _value);
        }
        #endregion
        ...
        public void setValue(string _key, JsonNode _value)
        {
            key = _key;
            value = _value;
            type = JSONNODE;
        ...
        public JsonNode getJsonNodeValue() { return (JsonNode)value; }
