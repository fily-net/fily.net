...
$View.depository.MaterialManager = function (j) {
    ...
    function layout() {
        ...
        var _mItemAry = [
            { title: '物资编号', name: 'code', comType: 'Input', group: { name: 'g1', width: 300} },
        ...
        var comArgs = {
            'rootTips': { head_h: 33, title: '物资结构管理', icon: 'fa fa-icon-th', cn: 'b0', gbsID: 121, toolBarSkin: 'mr10 Button-default', onToolBarClick: onToolBarClick },
            ...
            'infoView': { url: 'View/common/ListInfo.js', title: '物资基本信息', aHeader: _mHeaderAry, start: 250, fiAry: _mItemAry, table: 'SYS_WH_MS', onLoad: function (view) { dList = view; } }
        }
        var struct = {
            p: owner,
            name: 'rootTips',
