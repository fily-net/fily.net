...
$View.oa.Holiday = function (j) {
    ...
    function layout() {
        ...
        var comArgs = { 'root': { head_h: 30, foot_h: 0, cn: 'b0', title: '节假日设定', icon: 'fa-calendar', toolBarSkin: 'Button-default', toolBarAry: [{ text: _year + '年', value: _year, name: 'year', items: _yItems, type: 'menu', icon: 'fa-unsorted', cn: 'mr10'}], onToolBarMenuClick: onToolBarMenuClick} }
