...
$View.tools.ProjectGlobalTable = function (j) {
    var me = this, _fn = function () { };
    var owner;
    var args = { p: $DB, rootID: 5 };
    var coms = {}, infoF;
    ...
    function layout() {
        ...
        var comArgs = {
            'root': { head_h: 30, title: '系统全局对照表管理', icon: 'icon-glyph-th-list', cn: 'b0' },
            'rootLayout': { min: 200, max: 500, isRoot: 1, start: 320, dir: 'we', dirLock: 2 },
            'infoForm': { title: '基本信息', updateApi: 'm=SYS_TABLE_TREE&table=SYS_CM_GLOBAL_TABLE&action=updateNodeByID', loadApi: 'm=SYS_TABLE_TREE&table=SYS_CM_GLOBAL_TABLE&action=getNodeByID', ifFixedHeight: false, head_h: 30, items: _fiAry },
