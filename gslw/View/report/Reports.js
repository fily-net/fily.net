...
$View.crm.Reports = function (j) {
    ...
    function layout() {
        ...
        var hAry = [
            ...
            { title: '商家名称', name: 'm.merchantName', ifEnabledTips: true, type: 'none', width: 240 },
            { title: '行业类型', name: 'm.merchantType', type: 'select', ifTrans: true, width: 100 },
            { title: '地址', name: 'm.address', type: 'none', width: 380 },
