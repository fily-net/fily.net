...
$View.project.Supplier = function (j) {
    var me = this, _fn = function () { };
    var owner;
    var args = { p: $DB, tid: 'PRO_SUPPLIER', type: '745', title: '工程物资供应商申请' };
    var coms = {}, taskInfo, tkId, wfId, taskList, popTips, infoBody;
    var _taskAry = [
        { title: 'ID', name: 'id', type: 'attr' },
        { title: 'wfId', name: 'wfId', type: 'attr' },
        { title: '物资供应商', name: 'companyName', type: 'none', width: 250, ifEnabledTips: true, ifFilter: true, filterItems: ['like'] },
