...
$View.project.SettlementTariffStandard = function (j) {
    ...
    function layout() {
        ...
        var comArgs = {
            'rootTips': { head_h: 30, foot_h: 0, cn: 'b0', title: '工程结算资费标准', icon: 'fa fa-th-list', toolBarSkin: 'mr5 Button-default', gbsID: 128, onToolBarClick: onToolBarClick },
        ...
        switch (+obj.Name) {
            case 129:
                ...
                $.global.arrowTips.init({
                    ...
                    btnItems: [{ name: 'FORM-SYS-SUBMIT', text: '新建(Add)', icon: 'fa-plus', align: 'right'}],
            ...
            case 131:
                ...
                $.global.arrowTips.init({
                    ...
                    btnItems: [{ name: 'FORM-SYS-SUBMIT', text: '新建(Add)', icon: 'fa-plus', css: 'margin-right:38px;', align: 'right'}],
                    items: [
                        { title: '路面', name: 'luMianId', comType: 'Select', gtID: 710, group: { name: 'g1', width: 302}, req: true },
                        { title: '单价', name: 'price', comType: 'KeyInput', dataType: 'double', group: 'g1', req: true }
                    ],
