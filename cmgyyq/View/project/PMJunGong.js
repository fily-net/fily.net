...
$View.project.PMJunGong = function (j) {
    ...
    function layout() {
        ...
        var comArgs = {
            'taskInfo': {
                items: _fiAry,
                extLoadFields: ['dbo.SYS_TRANS_RIGHTS(' + ($.ck.get('SESSIONID') || '') + ', users,roles,0) as ifRights', 'state', 'proCode','accountWfId', 'planCost', 'realCost'],
