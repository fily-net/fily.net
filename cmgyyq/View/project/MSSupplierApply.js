...
$View.project.MSSupplierApply = function (j) {
    ...
    function layout() {
        ...
        var comArgs = {
            'root': { head_h: 33, title: '物资供应商申请', icon: 'fa fa-file-word-o', cn: 'b0', toolBarSkin: 'mr5 Button-default', gbsID: 75, onToolBarClick: onToolBarClick },
            ...
            'taskList': {
                aHeader: _taskAry,
                loadApi: 'm=SYS_TABLE_BASE&action=pagingForRightsWFList&table=DOC_WF',
                ifBindID: false,
