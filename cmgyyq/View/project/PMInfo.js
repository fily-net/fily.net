...
$View.project.PMInfo = function (j) {
    ...
    var owner;
    var args = { p: $DB, proId: 0, backUrl: 'View/project/PMFullScreen.js', proList: null, typeId: 0 };
    ...
    function layout() {
        ...
        var _toolBarAry = [];
        if (!args.proList) {
            _toolBarAry.push({ name: 'back', url: 'View/project/PMInfoForm.js', icon: 'fa fa-arrow-left', text: '返回' });
        }
        var comArgs = {
    ...
    function onToolBarClick(obj) {
        switch (obj.name) {
            case 'back':
                new $.UI.View({ p: args.p, url: args.backUrl, typeId: args.typeId });
                break;
        }
    }
