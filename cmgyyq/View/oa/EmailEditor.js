...
$View.oa.EmailEditor = function (j) {
    ...
    function layout() {
        var _toolBarAry = [
            { text: '发送', cn: 'mr3 mt5', name: 'send', icon: 'fa-hand-o-up', skin: 'Button-blue' },
            { text: '存草稿', cn: 'mt5', name: 'saveAsCopy', icon: 'fa-clipboard', skin: 'Button-s1' }
        ];
        var _formAry = [
        ...
        var comArgs = {
            'root': { head_h: 33, cn: 'b0', title: '写信', icon: 'fa-pencil-square-o', toolBarAry: _toolBarAry, toolBarSkin: 'Button-default', onToolBarClick: onToolBarClick },
