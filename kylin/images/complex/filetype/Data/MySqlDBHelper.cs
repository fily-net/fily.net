...
namespace Fily.Data
{
    ...
    {
        #region 变量定义
        private string _CLASS = "Fily.Data.MySqlDBHelper";
        #endregion
        ...
        public MySqlDBHelper(string conKey): base(conKey){}
        #endregion

        #region DBHelper: 有参数的构造函数
        public MySqlDBHelper(string server, string db, string username, string password) : base(server, db, username, password) { }
        #endregion

        public new MySqlConnection getDbConnecton()
        {
            ...
            try
            {
                ...
                {
                    connection = new MySqlConnection(dbInfo.toMyConnectionString());
