...
namespace Fily.Base
{
    public static class MySqlString
    {
        ...
        {
            string _sql = "insert into {0} ({1}) values ({2});", _return = format(_sql, _table, _key, _val);
        ...
        public static string getInsertStr(string _table, string _key, string _val, bool ifGetID)
        {
            ...
            if (ifGetID) { _sql += "select LAST_INSERT_ID();"; }
            return _sql;
        }
        #endregion
        ...
        {
            return getSelectStr(_table, _key, "id="+_id, "createTime", "asc");
        }
        #endregion
        ...
        {
            string _sql = "update {0} set delFlag='1',modifyTime=now() where {1};", _return = format(_sql, _table, _condition);
        ...
        {
            string _sql = "update {0} set delFlag='0',modifyTime=now() where {1};", _return = format(_sql, _table, _condition);
        ...
        {
            string _sql = "update {0} set modifyTime=now(),{1} where {2};", _return = format(_sql, _table, _update, _condition);
