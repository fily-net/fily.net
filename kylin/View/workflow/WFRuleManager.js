...
$View.workflow.WFRuleManager = function (j) {
    var me = this, _fn = function () { };
    var owner, eRule;
    var args = { p: $DB, table: 'SYS_WF_RULE' };
    var coms = {}, mainList, formTips;
    ...
    function layout() {
        ...
        var comArgs = {
            ...
            'structTips': { head_h: 33, foot_h: 33, icon: 'icon-glyph-list', title: '流程节点规则模版列表', cn: 'b0' },
            'infoTips': { head_h: 33, icon: 'icon-glyph-align-justify', title: '规则字段信息', cn: 'b0', onToolBarClick: onToolBarClick, toolBarAry: [{ name: 'newRuleItem', text: '新建规则项', icon: 'icon-compact-add-bold', cn: 'mr10 p3 mt3'}] },
