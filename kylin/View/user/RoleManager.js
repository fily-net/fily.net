$.NameSpace('$View.user');
$View.user.RoleManager = function (j) {
    var me = this, _fn = function () { };
    var owner;
    var args = { p: $DB }, coms, _api = 'm=SYS_CM_USERS', formBtn, infoF, toolBar;
    ...
    function layout() {
        ...
        var comArgs = {
            ...
            'roleTips': { head_h: 33, title: '角色列表', icon: 'icon-vector-man-full', cn: 'b0' },
            'userTips': { head_h: 33, title: '用户列表', icon: 'icon-glyph-user', cn: 'b0' },
            'roleList': { varName: 'roleList', aHeader: _roleHAry, loadApi: _api + '&action=getAllDepts&jsonCondition={"pid":2}', updateApi: _api + '&action=updateDept', onTDClick: onRoleClick, onSuccess: function (obj) { obj.List.fireClick(0); } },
