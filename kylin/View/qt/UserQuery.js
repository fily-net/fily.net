$.NameSpace('$View.qt');
$View.qt.UserQuery = function (j) {
    var me = this, _fn = function () { };
    var owner;
    var args = { p: $DB };
    var coms = {}, _paging, eBody, mList, curr;
    ...
    function loadTopicValues(uid) {
        mList.loadAjax({ args: 'm=SYS_TABLE_BASE&action=pagingForList&table=SYS_QT_PAPER_ANSWER&jsonCondition={"userId": ' + uid + '}' });
    }
