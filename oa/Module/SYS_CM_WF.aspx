...
<% 
    ...
    switch (action) {
        ...
        case "addWFInstance":
            ...
            {
                index = new WFIndex(hash.getInt("idxId"), baseApi);
                responseText = index.addInstance(hash.getString("alias"));
            }
            break;
        case "delWFInstance":
            args = new string[,] { 
        ...
        case "getWFCurrState":
            ...
            if (hash.getBool(Native.CHECK_RESULT))
            {
                ...
                _sql += MString.getSelectStr(T_INSTANCE, "id,dbo.SYS_TRANS_RIGHTS('" + MSession.get(MSession.getClientKey()) + "', owner,',',0) as rvalue, cPerson, state, link", "id=" + hash.getValue("instanceId"));
