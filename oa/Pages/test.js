$.namespace('$View.xd');
$View.xd.ImdbMovice = function (j) {
    var me = this, _fn = function () { };
    var owner;
    var args = { p: $DB };
    var coms = {}, infoBody, imgBody, currID, popTips, url;
    ...
    function layout() {
        ...
        var _taskAry = [
            ...
            { title: '影片名称', name: 'name', type: 'none', width: 120, ifFilter: true, filterItems: ['like'], ifEnabledTips: true },
            { title: '导演', name: 'daoyan', type: 'none', width: 120, ifFilter: true, filterItems: ['like'], ifEnabledTips: true },
            { title: '动画公司', name: 'company', type: 'none', width: 120, ifFilter: true, filterItems: ['like'], ifEnabledTips: true },
