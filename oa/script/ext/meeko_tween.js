KongNet.Tween =
{
    ...
    easeOutInCubic: function (t, b, c, d) { if (t < d / 2) { return mTween.easeOutCubic(t * 2, b, c / 2, d); }; return mTween.easeInCubic((t * 2) - d, b + c / 2, c / 2, d); },
    easeInQuart: function (t, b, c, d) { return c * (t /= d) * t * t * t + b; },
    easeOutQuart: function (t, b, c, d) { return -c * ((t = t / d - 1) * t * t * t - 1) + b; },
    easeInOutQuart: function (t, b, c, d) { if ((t /= d / 2) < 1) { return c / 2 * t * t * t * t + b; }; return -c / 2 * ((t -= 2) * t * t * t - 2) + b; },
    easeOutInQuart: function (t, b, c, d) { if (t < d / 2) { return mTween.easeOutQuart(t * 2, b, c / 2, d); }; return mTween.easeInQuart((t * 2) - d, b + c / 2, c / 2, d); },
    easeInQuint: function (t, b, c, d) { return c * (t /= d) * t * t * t * t + b; },
    easeOutQuint: function (t, b, c, d) { return c * ((t = t / d - 1) * t * t * t * t + 1) + b; },
    easeInOutQuint: function (t, b, c, d) { if ((t /= d / 2) < 1) { return c / 2 * t * t * t * t * t + b; }; return c / 2 * ((t -= 2) * t * t * t * t + 2) + b; },
    easeOutInQuint: function (t, b, c, d) { if (t < d / 2) { return mTween.easeOutQuint(t * 2, b, c / 2, d); }; return mTween.easeInQuint((t * 2) - d, b + c / 2, c / 2, d); },
    easeInSine: function (t, b, c, d) { return -c * Math.cos(t / d * (Math.PI / 2)) + c + b; },
    easeOutSine: function (t, b, c, d) { return c * Math.sin(t / d * (Math.PI / 2)) + b; },
    easeInOutSine: function (t, b, c, d) { return -c / 2 * (Math.cos(Math.PI * t / d) - 1) + b; },
    easeOutInSine: function (t, b, c, d) { if (t < d / 2) { return mTween.easeOutSine(t * 2, b, c / 2, d); }; return mTween.easeInSine((t * 2) - d, b + c / 2, c / 2, d); },
    ...
    easeOutInExpo: function (t, b, c, d) { if (t < d / 2) { return mTween.easeOutExpo(t * 2, b, c / 2, d); }; return mTween.easeInExpo((t * 2) - d, b + c / 2, c / 2, d); },
    ...
    easeOutInCirc: function (t, b, c, d) { if (t < d / 2) { return mTween.easeOutCirc(t * 2, b, c / 2, d); }; return mTween.easeInCirc((t * 2) - d, b + c / 2, c / 2, d); },
    ...
    easeOutInElastic: function (t, b, c, d, a, p) { if (t < d / 2) { return mTween.easeOutElastic(t * 2, b, c / 2, d, a, p); }; return mTween.easeInElastic((t * 2) - d, b + c / 2, c / 2, d, a, p);},
    ...
    easeOutInBack: function (t, b, c, d, s) { if (t < d / 2) { return mTween.easeOutBack(t * 2, b, c / 2, d, s); }; return mTween.easeInBack((t * 2) - d, b + c / 2, c / 2, d, s);},
    easeInBounce: function (t, b, c, d) { return c - mTween.easeOutBounce(d - t, 0, c, d) + b;},
    ...
    easeInOutBounce: function (t, b, c, d) { if (t < d / 2) { return mTween.easeInBounce(t * 2, 0, c, d) * .5 + b; } else { return mTween.easeOutBounce(t * 2 - d, 0, c, d) * .5 + c * .5 + b; };},
    easeOutInBounce: function (t, b, c, d) { if (t < d / 2) { return mTween.easeOutBounce(t * 2, b, c / 2, d); }; return mTween.easeInBounce((t * 2) - d, b + c / 2, c / 2, d);}
};