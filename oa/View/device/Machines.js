...
$View.device.Machines = function (args) {
    var me = this, coms, owner, _fn = function () { };
    var _args = { p: $DB, gtRootID: 156, fireid: null, infoUrl: 'View/device/MachinesInfo.js' }, popTips;
    var typeTab, mainList, currProType, toolBar;
    var ghAry = [
