...
$View.device.Car = function (args) {
    var me = this, coms, owner, _fn = function () { };
    var _args = { p: $DB, gtRootID: 156, fireid: null, infoUrl: 'View/device/CarInfo.js' }, popTips;
    var typeTab, mainList, currProType, toolBar, currID;
    var ghAry = [
