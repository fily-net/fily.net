...
$View.workflow.WFIndexManager = function (args) {
    ...
    function _layout() {
        ...
        var comArgs = {
            'root': { head_h: 38, title: '系统流程类型管理', icon: 'icon-glyph-wrench', cn: 'b0' },
    ...
    function _event() { }
    function _override() { }
    function onIfRightsChange(obj) { var _uFI = obj.FormItem.next; if (+obj.Value) { _uFI.show(); _uFI.next.show(); } else { _uFI.hide(); _uFI.next.hide(); } }
