...
$View.common.MasterSlave = function (args) {
    var me = this, coms, owner, _fn = function () { };
    var _args = { p: $DB, table: '', toolBarAry: [], ifLoadData: true, childs: [], listArgs: {}, wfIndexId: 0, fnId: 0, appId: 0, gtRootID: 1, pid: null, onAddFormBefore: _fn, onMainListClick: _fn, onLoadListSuccess: _fn, onListSuccessBefore: _fn };
    var lArgs = { colControls: { header: { height: 30 }, paging: { pageSize: 20, pageIndex: 1 } } };
    var popTips, mList, infoF, btnSet, toolBar;
    var tab, btnSet, currID, childs = [], ifTree = false;
    var url = 'm=SYS_TABLE_BASE&table=';
    function _default() {

    }
    function _layout() {
        var _lArgs = $.init(args.listArgs, lArgs), _pObj = _lArgs.colControls.paging;
