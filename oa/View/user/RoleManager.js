$.namespace('$View.user');
$View.user.RoleManager = function (args) {
    ...
    function _layout() {
        ...
        var comArgs = {
            ...
            'roleTips': { head_h: 37, title: '角色列表', icon: 'icon-vector-man-full', cn: 'b0' },
            'userTips': { head_h: 37, title: '用户列表', icon: 'icon-glyph-user', cn: 'b0' },
