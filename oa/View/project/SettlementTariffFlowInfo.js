...
$View.project.SettlementTariffFlowInfo = function (args) {
    var me = this, coms, owner, _fn = function () { };
    var _args = { p: $DB, proId: 0, taskId: 0, wfId: 0, accountInfoId: 0, onNextSuccess: _fn };
    var taskInfo, popTips, _formHeadH = 0;
    var _realAry = [
        { name: 'id', type: 'attr' },
