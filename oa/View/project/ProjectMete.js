...
$View.project.ProjectMete = function (args) {
    var me = this, coms, owner, _fn = function () { };
    var _args = { p: $DB, proId: 0, dType: 0, cost: 0, wfIdx: 108, onSubmitSuccess: _fn };
    var _rVals = [], mainList, _allCost = 0, costP, _idx = new $.nCount(); _idx.getN();
    var _taskAry = [
        { name: 'id', type: 'attr' },
