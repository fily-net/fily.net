$.namespace('$View.pm');
$View.pm.Index = function (args) {
    var me = this, coms, owner, _fn = function () { };
    var _args = { p: $DB, gtRootID: 156, infoUrl: 'View/pm/PMInfo2.js' }, popTips, infoView, currProId, typeTab, mainList;
    function _default() { }
    function _layout() {
        ...
        var comArgs = {
            ...
            'infoView': { url: args.infoUrl, onNext: function () { mainList.refresh(); }, onLoad: function (view, self) { infoView = view; infoView.mainList = mainList; } }
        }
        var struct = {
            p: owner,
            type: 'Layout',
