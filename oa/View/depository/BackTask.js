...
$View.depository.BackTask = function (args) {
    ...
    function _layout() {
        ...
        var comArgs = {
            'root': { head_h: 35, title: '仓库退料管理', icon: 'icon-glyph-gift', cn: 'b0', toolBarSkin: 'mr10 Button-default', gbsID: 107, onToolBarClick: onToolBarClick },
