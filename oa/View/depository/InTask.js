...
$View.depository.InTask = function (args) {
    var me = this, coms, owner, _fn = function () { };
    var _args = { p: $DB };
    var taskInfo, tkId, taskList, currObj, msList, msInfos = {}, toolBar;
    var _msAry = [
    ...
    function _layout() {
        ...
        var comArgs = {
            'root': { head_h: 35, title: '仓库收料管理', icon: 'icon-glyph-gift', cn: 'b0', toolBarSkin: 'mr10 Button-default', gbsID: 105, onToolBarClick: onToolBarClick },
    ...
    function onToolBarClick(obj) {
        switch (+obj.Name) {
            case 108:
                ...
                var _form = new $.UI.Form({ p: _tempL.eHead, submitApi: 'm=SYS_CM_WH&action=create&type=receive&wfIdx=78', items: _fiAry, foot_h: 35, btnItems: [{ name: 'FORM-SYS-SUBMIT', text: '新建单据', icon: 'icon-glyph-plus-sign', css: 'margin-left:102px;' }, { name: 'selectms', text: '选择物资', icon: 'icon-glyph-shopping-cart', css: 'margin-left:8px;'}], onClick: onFormClick });
