$.namespace('$View.yh');
$View.yh.BaseStation = function (args) {
    var me = this, coms, owner, _fn = function () { };
    var _args = { p: $DB, table: 'YH_BASE_STATION' };
    function _default() { }
    function _layout() {
        ...
        var _mHeaderAry = [
            ...
            { title: '处理级别', name: 'chuLiLevel', ifTrans: true, type: 'none', ifFilter: true, filterItems: ['equal'], gtID: 279, width: 80 },
            { title: '客户', name: 'customer', type: 'none', width: 80 },
            { title: '来单部门', name: 'laiDanDept', ifTrans: true, type: 'none', ifFilter: true, filterItems: ['equal'], gtID: 279, width: 80 },
            ...
            { title: '地面状况', name: 'earthState', ifTrans: true, type: 'none', ifFilter: true, filterItems: ['equal'], gtID: 327, width: 80 }
        ];
        var _infoItems = [
        ...
        new $.UI.View({ p: args.p, url: 'View/yh/Base.js', table: args.table, type: 353, headAry: _mHeaderAry, infoAry: _infoItems });
    }
    function _event() { }
    function _override() { }
