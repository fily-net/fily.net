$.namespace('$View.oa');
$View.oa.NewsList = function (args) {
    ...
    function _layout() {
        ...
        var comArgs = {
            'root': { head_h: 38, foot_h: 25, cn: 'b0', title: '养护信息列表', icon: 'icon-glyph-th-list', toolBarSkin: 'Button-default', toolBarAry: [{ text: '回到首页', name: 'back', icon: 'icon-glyph-arrow-left', skin: 'btn-info' }], onToolBarClick: onToolBarClick },
